...
<input type="hidden" name="token" value="<?php echo $_SESSION['token'];?>" />
      <button id="comm-submit" type="submit" class="btn btn-fat btn-success">登录</button> <a href="<?php echo tsurl('user','register')?>">还没有注册？</a> | <a href="<?php echo tsurl('user','forgetpwd')?>">忘记密码？</a>
