...
<!--
<div class="patch">
<h1><?php echo $TS_CF['info'][version];?>系统补丁</h1>
<ul id="patchlist">
...
isupdate("<?php echo $TS_CF['info']['version'];?>");

$(document).ready(function(){
	$.getJSON("http://www.thinksaas.cn/index.php?app=upcenter&ac=patch&version=<?php echo $TS_CF['info']['version'];?>&callback=?", 
	function(data){
